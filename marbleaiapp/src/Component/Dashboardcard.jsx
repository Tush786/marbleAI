...
>
    ...
    <div className="stat gap-1 px-2 py-2">
      <div className='flex justify-between items-center h-10'>
        <div className="stat-title dark:text-slate-300 text-[15px] font-[500] text-left">{title}</div>
        <div>
      <div className={`stat-figure hover:bg-[#a5a4a4] ${isFocused ? 'block' : 'hidden'} px-1 py-1`}  onMouseEnter={togglePopover} >{icon}</div>
      {isPopoverVisible && (
        <div
      ...
      <div className='flex gap-3'>
        <div className={`stat-value dark:text-slate-300 text-[22px] font-[700]`}>{value}</div>
